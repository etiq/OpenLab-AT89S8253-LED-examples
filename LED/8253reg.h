...
Header file for the Atmel AT89S8253.
...
sfr CLKREG  = 0x8F;     /* Clock Register */
...
sfr P2      = 0xA0;     /* Port 2 */
sfr WDTRST  = 0xA6;     /* Watchdog Reset Register */
sfr WDTCON  = 0xA7;     /* Watchdog Control Register */
...
------------------------------------------------*/
#define X2_   0x01   /* Double Clock Frequency*/
...
/*------------------------------------------------
WDTRST (0xA6) Constant Values
------------------------------------------------*/
#define WDTRES1_  0x1E
#define WDTRES2_  0xE1

/*------------------------------------------------
WMCON (0xA7) Bit Values
------------------------------------------------*/
#define WDTEN_   0x01   /* Watchdog Enable in SW-Mode */
#define WSWRST_  0x02   /* Watchdog Timer Reset and EEPROM Ready,/Busy Flag */
#define HWDT_    0x04   /* Hardware Mode Select */   
#define DISRTO_  0x80   /* Disable Reset Out */
#define WDIDLE_  0x10   /* Enable Watchdog in Idle Mode */
